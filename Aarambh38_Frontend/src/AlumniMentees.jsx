...
export default function AlumniMentees() {
  ...
  const filteredMentees = mentees.filter((student) => {
    ...
    return (
      ...
      student.batch?.toString().includes(query) ||
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-green-100 px-6 py-12 relative">
      <h1 className="text-4xl font-bold text-center mb-8 text-blue-700">Your Mentees</h1>

      {/* 🔍 Search Bar */}
      <div className="max-w-lg mx-auto mb-12">
        <input
          type="text"
          placeholder="Search by name, college, branch, batch, or gender..."
          value={searchQuery}
