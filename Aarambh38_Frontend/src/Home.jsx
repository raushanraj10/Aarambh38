...
//       message: "Being part of संyukt38 as an alumni has been incredibly rewarding. I love helping juniors navigate their career paths and seeing them succeed.",
//     },
//     {
//       id: 3,
//       name: "Rahul Mishra",
...
const filteredTestimonials = testimonials.filter(
    (testimonial) => testimonial.collegeReview?.trim()
);
    ...
    useEffect(() => {
        const fetchAlumni = async () => {
            try {
                const response = await axios.get(`${BASE_URL}/getAllAlumni`, {
                    withCredentials: true
                });
                console.log("Testimonials data:", response.data); // Debug log
